...
# Path ke file Excel
NEW_EXCEL_FILE = "C:\Asti\Bismillah\datasets\stories.xlsx"
...
data = pd.read_excel('C:\Asti\Bismillah\datasets\Bullying Dataset neww.xlsx')  # Ganti path jika perlu
